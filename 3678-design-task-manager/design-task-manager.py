class TaskManager:
    ...
    def __init__(self, tasks: List[List[int]]):
        ...
        for task in tasks:
            ...
            heappush(self.t_hq,(-p,-t))#for the heap to add as maxheap as python's heap is meanheap by default
    ...
    def execTop(self) -> int:
        while True:
            if not self.t_hq:#if the tasks list is empty that is no tasks available 
                return -1
